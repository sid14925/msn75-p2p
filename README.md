...
Két változat érhető el külön oldalakon:

| Oldal | Leírás |
|---|---|
| **https://sid14925.github.io/msn75-p2p/** | **Tisztított (lite) változat** — a copyright-átvizsgálás utáni build: saját rajzolt ikonok, Unicode-emojik, szintetizált hangok. Nem tartalmaz Microsoft-tulajdonú anyagot. |
...
- A `teljes.html` a Microsoft MSN Messenger 7.5 programjából származó
  ...
  repó tulajdonosa nosztalgia-célból, saját döntésére és felelősségére
  teszi elérhetővé; a Microsoft kérésére eltávolításra kerülnek.
